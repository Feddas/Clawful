...
namespace InputShareDevice
{
    ...
    /// </summary>
    [CustomEditor(typeof(UiRebindAction))]
    public class UiRebindActionEditor : UnityEditor.Editor
    {
        protected void OnEnable()
        {
            ...
            m_AllowDuplicateBindingsProperty = serializedObject.FindProperty("m_AllowDuplicateBindings");
        ...
        public override void OnInspectorGUI()
        {
            ...
            using (new EditorGUI.IndentLevelScope())
            {
                ...
                EditorGUILayout.PropertyField(m_AllowDuplicateBindingsProperty);
            }
        ...
        private SerializedProperty m_AllowDuplicateBindingsProperty;
