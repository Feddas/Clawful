...
namespace UnityEngine.InputSystem.Samples.UiRebind
{
    ...
    /// </summary>
    public class uGuiRebindAction : MonoBehaviour
    {
        /// <summary>
        ...
        protected void OnEnable()
        {
            if (s_RebindActionUIs == null)
                s_RebindActionUIs = new List<uGuiRebindAction>();
        ...
        private static List<uGuiRebindAction> s_RebindActionUIs;
        ...
        [Serializable]
        public class UpdateBindingUIEvent : UnityEvent<uGuiRebindAction, string, string, string>
        {
        }

        [Serializable]
        public class InteractiveRebindEvent : UnityEvent<uGuiRebindAction, InputActionRebindingExtensions.RebindingOperation>
        {
        }
    }
}
